...
namespace Microsoft.Diagnostics.Monitoring.WebApi {
    ...
    public class OptionsDisplayStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The lisst of request paths to monitor. If not specified, all request paths are monitored.  A request path must exactly match one of the items in the list to be monitored. Request paths matching the ExcludePaths list will not be monitored..
        /// </summary>
