...
namespace Microsoft.Diagnostics.Tools.Monitor
{
    class Program
    {
        ...
        private static Command ConfigCommand()
        {
            ...
            showCommand.SetHandler<string[], string[], bool, string, bool, bool, bool, ConfigDisplayLevel>(ConfigShowCommandHandler.Invoke, showCommand.Children.OfType<IValueDescriptor>().ToArray());
