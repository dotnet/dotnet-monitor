...
namespace Microsoft.Diagnostics.Monitoring.Tool.UnitTests
{
    public sealed class ExceptionsStoreTests
    {
        ...
        {
            await using ExceptionsStore store = new ExceptionsStore(Array.Empty<IExceptionsStoreCallbackFactory>(), new ExceptionsConfigurationSettings());
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ExceptionsStore(null, null));
        }
        ...
        public async Task ExceptionsStore_AddInstance_ContainsOne()
        {
            ...
            await using ExceptionsStore store = new(new[] { new PassThroughCallbackFactory(callback) }, new ExceptionsConfigurationSettings());
        ...
        public async Task ExceptionsStore_AddTwoRemoveOne_ContainsOne()
        {
            ...
            await using ExceptionsStore store = new(new[] { new PassThroughCallbackFactory(aggregateCallback) }, new ExceptionsConfigurationSettings());
