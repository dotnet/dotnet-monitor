...
namespace Microsoft.Diagnostics.Monitoring.Tool.UnitTests
{
    public sealed class CollectLogsActionTests
    {
        ...
        [InlineData(LogFormat.NDJson)]
#endif
        public async Task CollectLogsAction_Success(LogFormat logFormat)
        {
        ...
        private async Task ValidateResponseStream(AppRunner runner, Stream stream, Func<ChannelReader<LogEntry>, Task> callback, LogFormat logFormat)
        {
        ...
        // Move this into TestCommon so we can share it
