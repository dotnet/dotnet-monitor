...
namespace Microsoft.Diagnostics.Monitoring.Tool.UnitTests
{
    public sealed class CollectGCDumpActionTests
    {
        ...
        private ILogger<CollectGCDumpAction> _logger;
        ...
        private void SetUpHost(string egressProvider)
        {
            ...
            _logger = host.Services.GetRequiredService<ILoggerFactory>().CreateLogger<CollectGCDumpAction>();
        ...
        [Fact]
        public async Task CollectGCDumpAction_FileEgressProvider()
        {
            //SetUpHost(null);
            ...
            }, async host =>
            {
                ...
                CollectGCDumpAction action = new(_logger, _serviceProvider);
