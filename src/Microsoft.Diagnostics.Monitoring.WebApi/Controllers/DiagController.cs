    ...
    public partial class DiagController : ControllerBase
    {
            ...
            string tag = null)
        {
            ...
            return InvokeForProcess(processInfo =>
            {
                ...
                return StartTrace(processInfo, aggregateConfiguration, duration, egressProvider, tag);
            ...
            string tag = null)
        {
            ...
            return InvokeForProcess(processInfo =>
            {
                ...
                return StartTrace(processInfo, traceConfiguration, duration, egressProvider, tag);
            }, processKey, Utilities.ArtifactType_Trace);
        }
            ...
            string tag = null)
        {
            ...
            return InvokeForProcess(processInfo =>
            {
                ...
                return StartLogs(processInfo, settings, egressProvider, tag);
            ...
            string tag = null)
        {
            ...
            return await InvokeForProcess(async processInfo =>
            {
                ...
                }, StackUtilities.GenerateStacksFilename(processInfo.EndpointInfo, plainText), ContentTypeUtilities.MapFormatToContentType(stackFormat), processInfo, tag, asAttachment: false);
            ...
            bool asAttachment = true)
        {
            ...
            {
                await RegisterCurrentHttpResponseAsOperation(processInfo, artifactType, tag, operation);
            ...
            bool asAttachment = true)
        {
            ...
            if (string.IsNullOrEmpty(providerName))
            {
                await RegisterCurrentHttpResponseAsOperation(processInfo, artifactType, tag);
                return new OutputStreamResult(
                    action,
                    contentType,
        ...
        private async Task RegisterCurrentHttpResponseAsOperation(IProcessInfo processInfo, string artifactType, string tag, IArtifactOperation operation = null)
        {
            ...
            HttpContext.Response.Headers["Location"] = await RegisterOperation(
                new HttpResponseEgressOperation(HttpContext, processInfo, tag, operation),
                limitKey: artifactType);
        }
