...
1. Docker image build from main branch requires assets to be published to `dotnetcli` storage accounts. See [Release to Storage Accounts](#release-to-storage-accounts).
