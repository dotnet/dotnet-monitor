...
Submits a request to captures parameters for one or more methods each time they are called. The captured parameters can be retrieved through the ['GET /parameters' route](parameters-get.md).
