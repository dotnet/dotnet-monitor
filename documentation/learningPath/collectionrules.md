...
* Collection rules are registered [here](https://github.com/dotnet/dotnet-monitor/blob/de9b2ea7b9423029f655819447ff9a5c7e4e7f96/src/Tools/dotnet-monitor/ServiceCollectionExtensions.cs#L141). When adding a new trigger or action, these types need to be added here to take effect. This section is also responsible for making sure options get configured and validated.
* Options for collection rules can be found [here](https://github.com/dotnet/dotnet-monitor/blob/de9b2ea7b9423029f655819447ff9a5c7e4e7f96/src/Tools/dotnet-monitor/CollectionRules/Options/CollectionRuleOptions.cs).
...
* The pipeline responsible for the lifetime of a single executing collection rule can be found [here](https://github.com/dotnet/dotnet-monitor/blob/de9b2ea7b9423029f655819447ff9a5c7e4e7f96/src/Tools/dotnet-monitor/CollectionRules/CollectionRulePipeline.cs#L56).
* To run collection rules, `dotnet monitor` must be in `Listen` mode - this is set via [DiagnosticPortOptions](https://github.com/dotnet/dotnet-monitor/blob/de9b2ea7b9423029f655819447ff9a5c7e4e7f96/src/Microsoft.Diagnostics.Monitoring.Options/DiagnosticPortOptions.cs).
