...
* Collection rules are registered [here](https://github.com/dotnet/dotnet-monitor/blob/9ba2e5558604d3ee17edf914cc37fc50ba8ea256/src/Tools/dotnet-monitor/ServiceCollectionExtensions.cs#L141). When adding a new trigger or action, these types need to be added here to take effect. This section is also responsible for making sure options get configured and validated.
* Options for collection rules can be found [here](https://github.com/dotnet/dotnet-monitor/blob/9ba2e5558604d3ee17edf914cc37fc50ba8ea256/src/Tools/dotnet-monitor/CollectionRules/Options/CollectionRuleOptions.cs).
...
* The pipeline responsible for the lifetime of a single executing collection rule can be found [here](https://github.com/dotnet/dotnet-monitor/blob/9ba2e5558604d3ee17edf914cc37fc50ba8ea256/src/Tools/dotnet-monitor/CollectionRules/CollectionRulePipeline.cs#L56).
* To run collection rules, `dotnet monitor` must be in `Listen` mode - this is set via [DiagnosticPortOptions](https://github.com/dotnet/dotnet-monitor/blob/9ba2e5558604d3ee17edf914cc37fc50ba8ea256/src/Microsoft.Diagnostics.Monitoring.Options/DiagnosticPortOptions.cs).
